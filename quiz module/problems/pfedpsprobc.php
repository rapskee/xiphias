...
/************************************************************************/
  ...
  $question = "<p>Priscilla was given <a href='http://dcs.adnu.edu.ph/~neithan/pfedpsprobc.ods' style='color:#880000'>an edited version of the document that Eugene (from problem A) was given by her manager</a>. <br /></p>
<p>Out of curiosity Priscilla would want to know the following: <br /></p>
<p>(1) The number of values that are less than 10000 in the range H68:P97 <br /></p>
<p>(2) The number of values that are greater than 5000 in the range A1 - R105 <br /></p>
<p>You decide to help out, because you are a common friend of Priscilla and Eugene. <br /></p>
<p>Given this spreadsheet document, determine the count of values that Priscilla wants to know.</p> ";
